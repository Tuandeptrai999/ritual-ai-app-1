...
4. Specific Shortcuts:
   ...
   - For "zealot", strictly query search_knowledge(query="Ritual official zealot list count members"). Answer exactly how many there are and list their names accurately.
   - For "radiant ritualist", strictly query search_knowledge(query="Ritual official radiant ritualist list count members"). Answer exactly how many there are and list their names accurately.
